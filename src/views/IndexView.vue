    ...
    <div class="content">
      ...
      <div class="new-user" v-for="product in xinShouBao" :key="product.id">
        ...
        <div class="new-user-number">
          ...
          <a href="javascript:void(0)" @click="goLink('/page/product/detail', {productId: product.id})" target="_blank" class="new-user-btn">立即投资</a>
        </div>
